...
android {
    ...
    defaultConfig {
        applicationId = "com.acronet.marketpulse"
        minSdk = 26
        targetSdk = 35
        versionCode = 8
        versionName = "8.5.0"
...
dependencies {
    ...
    // ─── ACRONET V7 OBSIDIAN FORGE DEPENDENCIES ─────────────────
    ...
    // 5. MPAndroidChart — Advanced charting for MarketPulse Decoy UI
    implementation("com.github.PhilJay:MPAndroidChart:v3.1.0")

    // 6. ConstraintLayout — Auth Gate UI
